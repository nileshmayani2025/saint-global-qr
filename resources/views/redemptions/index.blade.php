...
@section('content')
    ...
    <form method="GET" class="mb-4 grid sm:grid-cols-3 gap-3">
        <input name="search" value="{{ $filters['search'] ?? '' }}" placeholder="Search reference / user…" class="rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 px-3 py-2 text-sm">
